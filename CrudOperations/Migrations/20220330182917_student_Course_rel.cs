...
{
    public partial class student_Course_rel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CourseDepartment", x => new { x.DeptId, x.CourseId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_CourseDepartment_Departments_DeptId",
                        column: x => x.DeptId,
